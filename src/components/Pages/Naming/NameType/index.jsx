...
const NameType = ({ text, name, setValue }) => {
  ...
  return (
    <div className="w-full">
      ...
      <ul className="sm:p-4 grid grid-cols-1 gap-5 md:gap-[35px]">
        {list.map((element, index) => (
          <DocSelect
            ...
            classBox="border border-main rounded-[4px] h-[100px] sm:h-[130px] flex items-center px-8"
          />
        ))}
      </ul>
    </div>
